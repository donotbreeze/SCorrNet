...
if __name__ == "__main__":
    ...
    ref_image = Image.open("Reference and deformed images/Sample12/oht_cfrp_00.tiff").convert('L')
    tar_image = Image.open("Reference and deformed images/Sample12/oht_cfrp_08.tiff").convert('L')
