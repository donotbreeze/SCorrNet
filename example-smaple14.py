...
if __name__ == "__main__":
    ...
    ref_image = Image.open("Reference and deformed images/Sample14/Sample14 Reference.tif").convert('L')
    tar_image = Image.open("Reference and deformed images/Sample14/Sample14 L3 Amp0.1.tif").convert('L')
    ...
    plt.colorbar()
    plt.savefig("Results/smaple14-dis_x.png")

    plt.figure()
    plt.imshow(mask[0],cmap='gray',vmin=0,vmax=1)
    plt.savefig("Results/smaple14-mask.png")
